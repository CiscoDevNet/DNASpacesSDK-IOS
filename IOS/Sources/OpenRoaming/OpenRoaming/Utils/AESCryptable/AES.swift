...
public struct AES {
    ...
    internal let ivSize: Int            = 0;//kCCBlockSizeAES128
    internal let options: UInt32        = CCOptions(kCCOptionECBMode + kCCOptionPKCS7Padding)
...
//        The sdkToken uses a non 256 bits key
